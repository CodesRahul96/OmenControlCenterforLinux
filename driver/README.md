...
```bash
git clone https://github.com/CodesRahul96/OmenControlCenterforLinux
cd OmenControlCenterforLinux/driver
sudo ./setup.sh
```
...
```nix
{
  inputs = {
    ...
    hp_wmi_control.url = "github:CodesRahul96/OmenControlCenterforLinux";
  };
